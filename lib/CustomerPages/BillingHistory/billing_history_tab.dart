...
class BillingHistoryTab extends StatefulWidget {
  final String monthString;
  const BillingHistoryTab({Key? key, required this.monthString})
      : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return _BillingHistoryTab();
  }
}

class _BillingHistoryTab extends State<BillingHistoryTab> {
  @override
